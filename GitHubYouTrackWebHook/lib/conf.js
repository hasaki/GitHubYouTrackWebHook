...
module.exports = function (config) {
	...
	function matchRegexArray(array, value, prefix) {
		if (prefix == null)
			prefix = '';
	...
	conf.branchMatches = function (branch) {
		return matchRegexArray(_config.github.branches, branch, 'refs\/heads\/');
	}
	
	conf.repositoryMatches = function (repo) {
		return matchRegexArray(_config.github.repositories, repo);
	}
